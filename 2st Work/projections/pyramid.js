...
{
    pyramidAddQuadrangularFace(0,1,2,3,vec3(0,-1,0));
    pyramidAddTriangularFace(0,4,1,vec3(-Math.sin(Math.atan(2)),Math.cos(Math.atan(2)),0));
    pyramidAddTriangularFace(0,3,4,vec3(0,Math.cos(Math.atan(2)),Math.sin(Math.atan(2))));
    pyramidAddTriangularFace(3,2,4,vec3(Math.sin(Math.atan(2)),Math.cos(Math.atan(2)),0));
    pyramidAddTriangularFace(1,2,4,vec3(0,Math.cos(Math.atan(2)),-Math.sin(Math.atan(2))));
}
...
function pyramidAddQuadrangularFace(a, b, c, d, n)
{
...
function pyramidAddTriangularFace(a, b, c, n)
{
    var offset = pyramid_points.length;
